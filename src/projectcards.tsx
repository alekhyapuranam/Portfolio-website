                    ...
                    <div className="h-3/4 w-full relative">
                        ...
                        <div className="absolute top-0 right-0 m-2 opacity-0 group-hover:opacity-100  transition-opacity">
                            <a href={project.githubLink} target="_blank" rel="noopener noreferrer">
                                <svg className=" transition-transform duration-300 hover:scale-110" width="50px" height="50px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
